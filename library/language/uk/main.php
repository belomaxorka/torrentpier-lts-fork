...
$lang['HIDE_CAT_MESS'] = 'Частина категорій прихована "Опціями показу" &middot; <a href="index.php?sh=1">Дивитися всі</a>';
$lang['TOPIC'] = 'Тема';
$lang['TOPICS'] = 'Теми';
...
$lang['CLICK_VIEW_PRIVMSG'] = '%sПерейти до папки &laquo;Вхідні&raquo;%s';
...
$lang['BT_GEN_PASSKEY_NEW'] = "Увага!\n\nПісля створення нового passkey, вам необхідно буде заново завантажити всі активні торренти!\n\nВи впевнені, що хочете створити новий passkey?";
...
$lang['TOR_STATUS_FORBIDDEN'] = 'Статус цієї роздачі: ';
...
$lang['TOR_AUTH_SENT_COMMENT'] = ' &middot; <span class="seed bold">Інформація відправлена модератору. Чекайте.</span>';
...
$lang['DELETE_POSTS_NOT_SUCCESFULLY'] = 'Не було видалено жодного повідомлення';
...
$lang['SWITCH'] = 'Перейти';
$lang['TOGGLE_WINDOW_FULL_SIZE'] = 'Збільшити/зменшити список';
...
$lang['NO_WATCHED_TOPICS'] = 'Немає відстежуваних тем';
...
$lang['TP_FORK_VERSION'] = 'Версія TorrentPier II Fork';
...
$lang['FLOOD_INTERVAL'] = 'Затримка &laquo;флуду&raquo;';
...
$lang['HOT_THRESHOLD'] = 'Повідомлення у &laquo;популярної&raquo; теми';
...
$lang['DELETE_DISALLOW_EXPLAIN'] = "Ви можете прибрати заборонене ім'я, вибравши його зі списку та натиснувши кнопку &laquo;зберегти&raquo;";
...
$lang['MANAGE_QUOTAS_EXPLAIN'] = 'Тут Ви можете додати/видалити/змінити квоти для розширень. Пізніше Ви можете прикріпити ці обмеження до певним користувачам або групам. Щоб прикріпити обмеження до користувача, відкрийте Користувачі-&gtУправление, виберіть користувача і Ви побачите необхідні налаштування внизу сторінки. Щоб прикріпити обмеження до групи, відкрийте Групи-&gtУправление, виберіть групу і Ви побачите панель налаштувань. Якщо Ви хочете побачити, які користувачі та групи прикріплені до певних обмежень, натисніть на "Подивитися" зліва від опису квоти.';
...
$lang['SEARCH_FOR_LASTVISITED_INTHELAST'] = 'Пошук користувачів, що відвідали трекер в останні %s';
$lang['SEARCH_FOR_LASTVISITED_AFTERTHELAST'] = 'Пошук користувачів, що відвідали трекер раніше ніж за останні %s';
...
$lang['TERMS_EMPTY_TEXT'] = '[align=center]Текст цієї сторінки редагується за адресою: [url]%s[/url]. Цю рядок бачать тільки адміністраторам.[/align]';
...
$lang['TR_STATS'] = array(
	...
	2 => 'середній розмір роздачі на трекері',
