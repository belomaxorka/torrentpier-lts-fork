...
> Список изменений (Fork): [CHANGELOG_FORK.md](https://github.com/belomaxorka/torrentpier-lts-fork/blob/main/CHANGELOG_FORK.md)
...
Минимально поддерживаемой версией PHP в настоящий момент является **5.4.0**. Существует поддержка вплоть до **5.6**
