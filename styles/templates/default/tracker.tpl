...
<div class="nav">
	...
	<p class="floatR"><a href="{U_TRACKER}?random_release=1">{L_RANDOM_RELEASE}</a><!-- IF MATCHES -->&nbsp;&middot;&nbsp;{MATCHES}&nbsp;{SERACH_MAX}<!-- ENDIF --></p>
	<div class="clear"></div>
</div>
	...
	<td class="row4" style="padding: 4px;">
		...
		<tr>
			<td colspan="2" width="50%">
				...
				<fieldset>
				<legend><span class="a-hash bold" onclick="$(this).addClass('bold').next().removeClass('bold'); $('#title_search').attr('name','{TITLE_MATCH_NAME}').attr('maxlength','{TITLE_MATCH_MAX}');">{L_TITLE_MATCH}</span>&nbsp;&middot;&nbsp;<span class="a-hash" onclick="$(this).addClass('bold').prev().removeClass('bold'); $('#title_search').attr('name','hash').attr('maxlength',40);">{L_HASH_S}</span></legend>
				<div>
					<p class="input">
